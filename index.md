...
For this proyect, first, we carry out a brief exploratory data analysis. Then, we preprocess the data and do some feature engieering. Finally, we `train different machine learning models` to see wich one fits better for our application: Logistic regression, Decision Trees, Random Forest, SVM and XGBoost`.
